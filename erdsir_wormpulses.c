...
if (tmp==0){
 ...
 TODO: tmp==0 as special pulse mode:

- so PWM disabled - re-enable when we exit this mode

oldtmp, changed

TCCR0B=0;

- pulse timing is speed for interval max 20s (delay) 20/255=0.08 s

pulsecounter

- (adcread(1)+adcread(5)) as length of pulse max 4s 4/255=0.015
